...
LD_FLAGS := -X github.com/jheinitz/evcc/server.Version=$(VERSION) -X github.com/jheinitz/evcc/server.Commit=$(COMMIT) -s -w
...
IMAGE_OPTIONS := -hostname evcc -http_port 8080 github.com/gokrazy/serial-busybox github.com/gokrazy/breakglass github.com/gokrazy/mkfs github.com/gokrazy/wifi github.com/jheinitz/evcc
...
docs::
	go generate github.com/jheinitz/evcc/util/templates/...
...
gokrazy::
	...
	mkdir -p env/github.com/jheinitz/evcc
	echo "EVCC_NETWORK_PORT=80" > env/github.com/jheinitz/evcc/env.txt
	echo "EVCC_DATABASE_DSN=/perm/evcc.db" >> env/github.com/jheinitz/evcc/env.txt
	mkdir -p buildflags/github.com/jheinitz/evcc
	echo "$(BUILD_TAGS),gokrazy" > buildflags/github.com/jheinitz/evcc/buildflags.txt
	echo "-ldflags=$(LD_FLAGS)" >> buildflags/github.com/jheinitz/evcc/buildflags.txt
...
soc::
	@echo Version: $(VERSION) $(SHA) $(BUILD_DATE)
	go build $(BUILD_TAGS) $(BUILD_ARGS) github.com/jheinitz/evcc/cmd/soc
