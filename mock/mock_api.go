...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,ChargerSync,PhaseSwitcher,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff)
...
// MockChargerSync is a mock of ChargerSync interface.
type MockChargerSync struct {
	ctrl     *gomock.Controller
	recorder *MockChargerSyncMockRecorder
}

// MockChargerSyncMockRecorder is the mock recorder for MockChargerSync.
type MockChargerSyncMockRecorder struct {
	mock *MockChargerSync
}

// NewMockChargerSync creates a new mock instance.
func NewMockChargerSync(ctrl *gomock.Controller) *MockChargerSync {
	mock := &MockChargerSync{ctrl: ctrl}
	mock.recorder = &MockChargerSyncMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockChargerSync) EXPECT() *MockChargerSyncMockRecorder {
	return m.recorder
}

// Update mocks base method.
func (m *MockChargerSync) Update() error {
	m.ctrl.T.Helper()
...
func (mr *MockChargerSyncMockRecorder) Update() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockChargerSync)(nil).Update))
}
