...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,PhaseSwitcher,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff,BatteryControl)
...
// MockBatteryControl is a mock of BatteryControl interface.
type MockBatteryControl struct {
	ctrl     *gomock.Controller
	recorder *MockBatteryControlMockRecorder
}

// MockBatteryControlMockRecorder is the mock recorder for MockBatteryControl.
type MockBatteryControlMockRecorder struct {
	mock *MockBatteryControl
}

// NewMockBatteryControl creates a new mock instance.
func NewMockBatteryControl(ctrl *gomock.Controller) *MockBatteryControl {
	mock := &MockBatteryControl{ctrl: ctrl}
	mock.recorder = &MockBatteryControlMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatteryControl) EXPECT() *MockBatteryControlMockRecorder {
	return m.recorder
}

// CurrentPower mocks base method.
func (m *MockBatteryControl) CurrentPower() (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CurrentPower")
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
...
// CurrentPower indicates an expected call of CurrentPower.
func (mr *MockBatteryControlMockRecorder) CurrentPower() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CurrentPower", reflect.TypeOf((*MockBatteryControl)(nil).CurrentPower))
}

// GetBatteryMode mocks base method.
func (m *MockBatteryControl) GetBatteryMode() api.BatteryMode {
	m.ctrl.T.Helper()
...
func (mr *MockBatteryControlMockRecorder) GetBatteryMode() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBatteryMode", reflect.TypeOf((*MockBatteryControl)(nil).GetBatteryMode))
}

// SetBatteryMode mocks base method.
func (m *MockBatteryControl) SetBatteryMode(arg0 api.BatteryMode) error {
	m.ctrl.T.Helper()
...
func (mr *MockBatteryControlMockRecorder) SetBatteryMode(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetBatteryMode", reflect.TypeOf((*MockBatteryControl)(nil).SetBatteryMode), arg0)
}
