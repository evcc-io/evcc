...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,PhaseSwitcher,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff,BatteryCapacity)
...
// MockBatteryCapacity is a mock of BatteryCapacity interface.
type MockBatteryCapacity struct {
	ctrl     *gomock.Controller
	recorder *MockBatteryCapacityMockRecorder
}

// MockBatteryCapacityMockRecorder is the mock recorder for MockBatteryCapacity.
type MockBatteryCapacityMockRecorder struct {
	mock *MockBatteryCapacity
}

// NewMockBatteryCapacity creates a new mock instance.
func NewMockBatteryCapacity(ctrl *gomock.Controller) *MockBatteryCapacity {
	mock := &MockBatteryCapacity{ctrl: ctrl}
	mock.recorder = &MockBatteryCapacityMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatteryCapacity) EXPECT() *MockBatteryCapacityMockRecorder {
	return m.recorder
}
...
// Capacity indicates an expected call of Capacity.
func (mr *MockBatteryCapacityMockRecorder) Capacity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Capacity", reflect.TypeOf((*MockBatteryCapacity)(nil).Capacity))
}
