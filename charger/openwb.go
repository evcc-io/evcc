...
//go:generate go run ../cmd/tools/decorate.go -f decorateOpenWB -b *OpenWB -r api.Charger -t "api.PhaseController,Phases1p3p,func(int) error" -t "api.Battery,Soc,func() (float64, error)"
