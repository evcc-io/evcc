...
func TestMobileConnect_MaxCurrent(t *testing.T) {
	tests := []struct {
		...
		// test cases for software version 2914
		{
			...
			[]apiResponse{
				{apiCurrentCableInformation, "\"{\\\"carCable\\\":5,\\\"gridCable\\\":8,\\\"hwfpMaxLimit\\\":32,\\\"maxValue\\\":10,\\\"minValue\\\":6,\\\"value\\\":10}\""},
				{apiSetCurrentLimit, "\"OK\"\n"},
			},
			6, false,
		},
		{
		...
		},
		{
			...
			[]apiResponse{
				{apiCurrentCableInformation, "\"{\\\"carCable\\\":5,\\\"gridCable\\\":8,\\\"hwfpMaxLimit\\\":32,\\\"maxValue\\\":10,\\\"minValue\\\":6,\\\"value\\\":10}\""},
				{apiSetCurrentLimit, "Unexpected response"},
			},
			10, true,
		},
	}
