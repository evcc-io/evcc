...
func (suite *ocppTestSuite) TestConnect() {
	...
	c1, err := NewOCPP(context.TODO(), "test-1", 1, "", "", 0, false, false, false, true, ocppTestConnectTimeout)
	...
	c2, err := NewOCPP(context.TODO(), "test-2", 1, "", "", 0, false, false, false, true, ocppTestConnectTimeout)
	suite.Require().NoError(err)
...
func (suite *ocppTestSuite) TestAutoStart() {
	...
	// 1st charge point- local
	c1, err := NewOCPP(context.TODO(), "test-3", 1, "", "", 0, false, false, false, false, ocppTestConnectTimeout)
	suite.Require().NoError(err)
...
func (suite *ocppTestSuite) TestTimeout() {
	...
	// 1st charge point- local
	_, err := NewOCPP(context.TODO(), "test-4", 1, "", "", 0, false, false, false, false, ocppTestConnectTimeout)
