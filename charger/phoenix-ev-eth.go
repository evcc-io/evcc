...
//go:generate go run ../cmd/tools/decorate.go -f decoratePhoenixEVEth -b api.Charger,api.ChargeTimer -t "api.Meter,CurrentPower,func() (float64, error)" -t "api.MeterEnergy,TotalEnergy,func() (float64, error)" -t "api.MeterCurrent,Currents,func() (float64, float64, float64, error)"
...
func NewPhoenixEVEthFromConfig(other map[string]interface{}) (api.Charger, error) {
	...
	return decoratePhoenixEVEth(wb, wb, currentPower, totalEnergy, currents), err
}
