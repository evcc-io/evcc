...
// Source: github.com/evcc-io/evcc/db/settings (interfaces: API)
//
// Generated by this command:
//
//	mockgen -package settings -destination mock.go -mock_names API=MockAPI github.com/evcc-io/evcc/db/settings API
//
