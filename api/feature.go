...
const (
	...
	PredictorProfileSameWeekday         // charger - demand forecast: same weekday last week (warm water)
	PredictorProfileTemperature         // charger - demand forecast: daily avg scaled by outdoor temp (room heating)
