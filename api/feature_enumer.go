...
const _FeatureName = "CoarseCurrentIntegratedDeviceSwitchDeviceHeatingContinuousAverageCacheableOfflineRetryableStreamingWelcomeChargeDisableChargingOnClimaterActive"

var _FeatureIndex = [...]uint8{0, 13, 29, 41, 48, 58, 65, 74, 81, 90, 99, 112, 143}

const _FeatureLowerName = "coarsecurrentintegrateddeviceswitchdeviceheatingcontinuousaveragecacheableofflineretryablestreamingwelcomechargedisablechargingonclimateractive"
...
func _FeatureNoOp() {
	...
	_ = x[DisableChargingOnClimaterActive-(12)]
}

var _FeatureValues = []Feature{CoarseCurrent, IntegratedDevice, SwitchDevice, Heating, Continuous, Average, Cacheable, Offline, Retryable, Streaming, WelcomeCharge, DisableChargingOnClimaterActive}
...
var _FeatureNameToValueMap = map[string]Feature{
	...
	_FeatureName[112:143]:      DisableChargingOnClimaterActive,
	_FeatureLowerName[112:143]: DisableChargingOnClimaterActive,
}
