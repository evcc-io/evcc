...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,CurrentLimiter,CurrentGetter,PhaseSwitcher,PhaseSwitchGuard,PhaseGetter,FeatureDescriber,Identifier,Meter,MeterEnergy,PhaseCurrents,Vehicle,ConnectionTimer,ChargeRater,Battery,BatteryController,BatterySocLimiter,Circuit,Dimmer,Tariff)
//
...
// MockPhaseSwitchGuard is a mock of PhaseSwitchGuard interface.
type MockPhaseSwitchGuard struct {
	ctrl     *gomock.Controller
	recorder *MockPhaseSwitchGuardMockRecorder
	isgomock struct{}
}

// MockPhaseSwitchGuardMockRecorder is the mock recorder for MockPhaseSwitchGuard.
type MockPhaseSwitchGuardMockRecorder struct {
	mock *MockPhaseSwitchGuard
}

// NewMockPhaseSwitchGuard creates a new mock instance.
func NewMockPhaseSwitchGuard(ctrl *gomock.Controller) *MockPhaseSwitchGuard {
	mock := &MockPhaseSwitchGuard{ctrl: ctrl}
	mock.recorder = &MockPhaseSwitchGuardMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPhaseSwitchGuard) EXPECT() *MockPhaseSwitchGuardMockRecorder {
	return m.recorder
}

// PhaseSwitchAllowed mocks base method.
func (m *MockPhaseSwitchGuard) PhaseSwitchAllowed() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PhaseSwitchAllowed")
	ret0, _ := ret[0].(bool)
	return ret0
}

// PhaseSwitchAllowed indicates an expected call of PhaseSwitchAllowed.
func (mr *MockPhaseSwitchGuardMockRecorder) PhaseSwitchAllowed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PhaseSwitchAllowed", reflect.TypeOf((*MockPhaseSwitchGuard)(nil).PhaseSwitchAllowed))
}
