...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,CurrentLimiter,CurrentGetter,PhaseSwitcher,PhaseGetter,FeatureDescriber,Identifier,Meter,MeterEnergy,PhaseCurrents,Vehicle,DisconnectDetector,ChargeRater,Battery,BatteryController,BatterySocLimiter,Circuit,Dimmer,Tariff)
//
...
// MockDisconnectDetector is a mock of DisconnectDetector interface.
type MockDisconnectDetector struct {
	ctrl     *gomock.Controller
	recorder *MockDisconnectDetectorMockRecorder
	isgomock struct{}
}

// MockDisconnectDetectorMockRecorder is the mock recorder for MockDisconnectDetector.
type MockDisconnectDetectorMockRecorder struct {
	mock *MockDisconnectDetector
}

// NewMockDisconnectDetector creates a new mock instance.
func NewMockDisconnectDetector(ctrl *gomock.Controller) *MockDisconnectDetector {
	mock := &MockDisconnectDetector{ctrl: ctrl}
	mock.recorder = &MockDisconnectDetectorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDisconnectDetector) EXPECT() *MockDisconnectDetectorMockRecorder {
	return m.recorder
}

// DisconnectDetected mocks base method.
func (m *MockDisconnectDetector) DisconnectDetected() (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DisconnectDetected")
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DisconnectDetected indicates an expected call of DisconnectDetected.
func (mr *MockDisconnectDetectorMockRecorder) DisconnectDetected() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DisconnectDetected", reflect.TypeOf((*MockDisconnectDetector)(nil).DisconnectDetected))
}
