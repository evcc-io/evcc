...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,CurrentLimiter,CurrentGetter,PhaseSwitcher,PhaseGetter,Identifier,Meter,EnergyImport,EnergyExport,PhaseCurrents,Vehicle,ChargeRater,Battery,Tariff,BatteryController,Circuit)
//
// Generated by this command:
//
//	mockgen -package api -destination mock.go github.com/evcc-io/evcc/api Charger,ChargeState,CurrentLimiter,CurrentGetter,PhaseSwitcher,PhaseGetter,Identifier,Meter,EnergyImport,EnergyExport,PhaseCurrents,Vehicle,ChargeRater,Battery,Tariff,BatteryController,Circuit
//
...
// MockEnergyExport is a mock of EnergyExport interface.
type MockEnergyExport struct {
	ctrl     *gomock.Controller
	recorder *MockEnergyExportMockRecorder
	isgomock struct{}
}

// MockEnergyExportMockRecorder is the mock recorder for MockEnergyExport.
type MockEnergyExportMockRecorder struct {
	mock *MockEnergyExport
}

// NewMockEnergyExport creates a new mock instance.
func NewMockEnergyExport(ctrl *gomock.Controller) *MockEnergyExport {
	mock := &MockEnergyExport{ctrl: ctrl}
	mock.recorder = &MockEnergyExportMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockEnergyExport) EXPECT() *MockEnergyExportMockRecorder {
	return m.recorder
}

// EnergyExport mocks base method.
func (m *MockEnergyExport) EnergyExport() (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnergyExport")
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// EnergyExport indicates an expected call of EnergyExport.
func (mr *MockEnergyExportMockRecorder) EnergyExport() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnergyExport", reflect.TypeOf((*MockEnergyExport)(nil).EnergyExport))
}
