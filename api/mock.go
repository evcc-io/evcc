...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,CurrentLimiter,CurrentGetter,PhaseSwitcher,PhaseGetter,FeatureDescriber,Identifier,Meter,MeterImport,PhaseCurrents,Vehicle,ConnectionTimer,ChargeRater,Battery,BatteryController,BatterySocLimiter,Circuit,Dimmer,Tariff)
//
...
// ImportTotal mocks base method.
func (m *MockMeterImport) ImportTotal() (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ImportTotal")
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ImportTotal indicates an expected call of ImportTotal.
func (mr *MockMeterImportMockRecorder) ImportTotal() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportTotal", reflect.TypeOf((*MockMeterImport)(nil).ImportTotal))
}
