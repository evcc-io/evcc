...
// MockCurtailer is a mock of Curtailer interface.
type MockCurtailer struct {
	ctrl     *gomock.Controller
	recorder *MockCurtailerMockRecorder
	isgomock struct{}
}

// MockCurtailerMockRecorder is the mock recorder for MockCurtailer.
type MockCurtailerMockRecorder struct {
	mock *MockCurtailer
}

// NewMockCurtailer creates a new mock instance.
func NewMockCurtailer(ctrl *gomock.Controller) *MockCurtailer {
	mock := &MockCurtailer{ctrl: ctrl}
	mock.recorder = &MockCurtailerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCurtailer) EXPECT() *MockCurtailerMockRecorder {
	return m.recorder
}

// Curtailed mocks base method.
func (m *MockCurtailer) Curtailed() (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCurtailerMockRecorder) Curtailed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Curtailed", reflect.TypeOf((*MockCurtailer)(nil).Curtailed))
}

// SetCurtailPercent mocks base method.
func (m *MockCurtailer) SetCurtailPercent(arg0 int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetCurtailPercent", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetCurtailPercent indicates an expected call of SetCurtailPercent.
func (mr *MockCurtailerMockRecorder) SetCurtailPercent(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCurtailPercent", reflect.TypeOf((*MockCurtailer)(nil).SetCurtailPercent), arg0)
}
