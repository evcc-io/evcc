...
// Source: github.com/evcc-io/evcc/api (interfaces: Charger,ChargeState,CurrentLimiter,PhaseController,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff,BatteryController)
//
// Generated by this command:
//
//	mockgen -package api -destination mock.go github.com/evcc-io/evcc/api Charger,ChargeState,CurrentLimiter,PhaseController,Identifier,Meter,MeterEnergy,Vehicle,ChargeRater,Battery,Tariff,BatteryController
//
...
// MockPhaseController is a mock of PhaseController interface.
type MockPhaseController struct {
	ctrl     *gomock.Controller
	recorder *MockPhaseControllerMockRecorder
}

// MockPhaseControllerMockRecorder is the mock recorder for MockPhaseController.
type MockPhaseControllerMockRecorder struct {
	mock *MockPhaseController
}

// NewMockPhaseController creates a new mock instance.
func NewMockPhaseController(ctrl *gomock.Controller) *MockPhaseController {
	mock := &MockPhaseController{ctrl: ctrl}
	mock.recorder = &MockPhaseControllerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPhaseController) EXPECT() *MockPhaseControllerMockRecorder {
	return m.recorder
}

// Phases1p3p mocks base method.
func (m *MockPhaseController) Phases1p3p(arg0 int) error {
	m.ctrl.T.Helper()
...
func (mr *MockPhaseControllerMockRecorder) Phases1p3p(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Phases1p3p", reflect.TypeOf((*MockPhaseController)(nil).Phases1p3p), arg0)
}
