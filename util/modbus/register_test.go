...
func TestDecoding(t *testing.T) {
	tc := []struct {
		...
		{Register{Decode: "uint64nans"}, []byte{0x00, 0x04, 0x00, 0x03, 0x00, 0x02, 0x00, 0x01}, 0x0001000200030004},         // normal LSW-first value
		{Register{Decode: "uint64nans"}, []byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}, 0},                          // all-0xFF sentinel -> 0
	}
