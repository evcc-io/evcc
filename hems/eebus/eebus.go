...
// Connected implements api.HEMS, reporting whether the EEBus connection to the
// Steuerbox is currently active.
...
// Failsafe implements api.HEMS, reporting whether evcc is currently operating
// in failsafe mode.
