...
func NewAiwaysFromConfig(ctx context.Context, other map[string]any) (api.Vehicle, error) {
	cc := struct {
	...
	log := util.LoggerFromContext(ctx, "aiways").Redact(cc.User, cc.Password, cc.VIN)
