...
func newPSA(log logx.Logger, brand, realm, id, secret string, other map[string]interface{}) (api.Vehicle, error) {
	cc := struct {
	...
	log = logx.Redact(log, cc.User, cc.Password, cc.VIN)
