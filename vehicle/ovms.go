...
func NewOvmsFromConfig(ctx context.Context, other map[string]any) (api.Vehicle, error) {
	cc := struct {
	...
	log := util.LoggerFromContext(ctx, "ovms").Redact(cc.User, cc.Password, cc.VehicleID)
