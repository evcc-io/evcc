...
// combo [[api.MeterEnergy] [api.Battery] [api.MeterEnergy api.Battery] [api.BatteryCapacity api.Battery] [api.MeterEnergy api.BatteryCapacity api.Battery] [api.Battery api.BatterySocLimiter] [api.MeterEnergy api.Battery api.BatterySocLimiter] [api.BatteryCapacity api.Battery api.BatterySocLimiter] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatterySocLimiter] [api.Battery api.BatteryPowerLimiter] [api.MeterEnergy api.Battery api.BatteryPowerLimiter] [api.BatteryCapacity api.Battery api.BatteryPowerLimiter] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatteryPowerLimiter] [api.Battery api.BatterySocLimiter api.BatteryPowerLimiter] [api.MeterEnergy api.Battery api.BatterySocLimiter api.BatteryPowerLimiter] [api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryPowerLimiter] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryPowerLimiter] [api.Battery api.BatteryController] [api.MeterEnergy api.Battery api.BatteryController] [api.BatteryCapacity api.Battery api.BatteryController] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatteryController] [api.Battery api.BatterySocLimiter api.BatteryController] [api.MeterEnergy api.Battery api.BatterySocLimiter api.BatteryController] [api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryController] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryController] [api.Battery api.BatteryPowerLimiter api.BatteryController] [api.MeterEnergy api.Battery api.BatteryPowerLimiter api.BatteryController] [api.BatteryCapacity api.Battery api.BatteryPowerLimiter api.BatteryController] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatteryPowerLimiter api.BatteryController] [api.Battery api.BatterySocLimiter api.BatteryPowerLimiter api.BatteryController] [api.MeterEnergy api.Battery api.BatterySocLimiter api.BatteryPowerLimiter api.BatteryController] [api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryPowerLimiter api.BatteryController] [api.MeterEnergy api.BatteryCapacity api.Battery api.BatterySocLimiter api.BatteryPowerLimiter api.BatteryController]]
