...
// e3dcBatteryModes are the modes the setter implements
var e3dcBatteryModes = implement.BatteryModes(api.BatteryNormal, api.BatteryHold, api.BatteryCharge, api.BatteryHoldCharge)
