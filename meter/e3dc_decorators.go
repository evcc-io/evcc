...
func decorateE3dc(base *E3dc, batteryCapacity func() float64, maxACPowerGetter func() float64, battery func() (float64, error), batteryController func(api.BatteryMode) error) api.Meter {
	switch {
