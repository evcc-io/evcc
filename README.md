...
- multiple [chargers](#charger): Wallbe, Phoenix (includes ESL Walli), go-eCharger, NRGkick (direct Bluetooth or via Connect device), SimpleEVSE, EVSEWifi, KEBA/BMW, openWB, Mobile Charger Connect, Smart-Home outlets with e-meter feature (Fritz!DECT, Tasmota, TP-Link) and any other charger using scripting
