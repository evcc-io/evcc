...
Sunny-Portal via the "Optional energy demand" slider. When the amount of configured PV is not reached, loading stops like in **PV** mode. So, pushing the slider completely
to the left makes **Min+PV** behave as described above. Pushing completely to the right and **Min+PV** mode behaves like **PV** mode. 
