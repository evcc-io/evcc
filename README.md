...
EVCC uses positive (+) sign for incoming power (grid purchases, PV inverter production or home battery discharge) and negative (-) sign for outgoing power (grid feed-in, PV inverter remaining usage or home battery charge). All remaining home power usage, including the charger power, is always of positive (+) sign.
