...
- multiple [chargers](#charger): Wallbe (tested with Wallbe Eco S), Phoenix controllers (similar to Wallbe), go-eCharger, KEBA KeContact and BMW, openWB slave, Mobile Charger Connect and any other charger using scripting
