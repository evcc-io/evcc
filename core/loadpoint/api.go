...
type API interface {
	...
	// OptimizerPlan returns the optimizer's charging schedule up to the plan time and its average power while in control
	OptimizerPlan(planTime time.Time) (api.Rates, float64)
