...
type API interface {
	...
	// GetPlanDuration returns the charge plan duration
	GetPlanDuration() (time.Time, time.Duration)
	// SetPlanDuration sets the charge plan duration
	SetPlanDuration(time.Time, time.Duration) error
