...
func RegisteredClient(log logx.Logger, broker, user, password, clientID string, qos byte, opts ...Option) (*Client, error) {
...
func RegisteredClientOrDefault(log logx.Logger, cc Config) (*Client, error) {
	var err error
	client := Instance
