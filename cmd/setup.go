...
// eebusSKIMigrationHint is the user-facing guidance printed alongside a
// legacy SKI validation error. Since evcc 0.309.2 ship-go enforces stricter
// SKI validation and rejects certificates generated by older versions.
const eebusSKIMigrationHint = "The stored EEBUS certificate uses an outdated SKI format that is no longer accepted since evcc 0.309.2.\n" +
	...
	"Note: users of §14a-EnWG compliant setups are recommended to stay on 0.309.1 or lower " +
	"with the old certificate, in parallel generate a new one and get the new SKI accepted " +
	"by their metering point operator, and upgrade afterwards."
