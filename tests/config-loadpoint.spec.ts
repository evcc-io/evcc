...
test.describe("heating loadpoint", async () => {
  ...
  test("user-defined heat pump", async ({ page }) => {
    ...
    await modal.getByLabel("Manufacturer").selectOption("User-defined heat pump (sg-ready via plugins)");
    await modal.getByLabel("Manufacturer").selectOption("User-defined heat pump (sg-ready via relays)");
