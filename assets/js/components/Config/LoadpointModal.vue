	...
	>
		...
		>
			...
			<FormRow
				...
				:error="!charger ? $t('config.loadpoint.chargerError') : undefined"
			>
				<div class="d-flex">
					<PropertyField
						id="loadpointParamCharger"
...
type LoadpointType = "charging" | "heating";
...
export default {
	...
	computed: {
		...
		chargerType() {
			return this.chargerIsHeating ? "heating" : "charging";
		},
		chargerTitle() {
