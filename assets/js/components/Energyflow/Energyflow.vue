<template>
	<div class="energyflow">
		...
		<div class="details" :style="{ height: detailsVisible ? `${detailsHeight}px` : '10px' }">
			<div ref="inner" class="details-inner row">
				<div class="col-12 d-flex justify-content-between pt-2 mb-5">
...
export default {
	...
	methods: {
		...
		updateDetailHeight: function () {
			this.detailsHeight = this.$refs.inner.offsetHeight;
		},
	},
};
</script>
...
.details {
	transition: height 0.5s cubic-bezier(0.5, 0.5, 0.5, 1.15);
}
.color-grid {
	color: var(--evcc-grid);
}
