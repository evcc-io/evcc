...
describe("SiteVisualization.vue", () => {
  ...
  it("using pv and grid power", () => {
    ...
    expect(wrapper.find(".label-usage").text()).toMatch("5.0 kW");
    expect(wrapper.find(".label-pv-export").text()).toMatch("0.0 kW");
  });
  ...
  it("exporting all pv power, no usage", () => {
    ...
    expect(wrapper.find(".label-usage").text()).toMatch("0.0 kW");
    expect(wrapper.find(".label-pv-export").text()).toMatch("4.0 kW");
  });
  ...
  it("only grid usage, no pv", () => {
    ...
    expect(wrapper.find(".label-usage").text()).toMatch("0.4 kW");
    expect(wrapper.find(".label-pv-export").text()).toMatch("0.0 kW");
  });
});
