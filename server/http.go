...
func (s *HTTPd) RegisterSiteHandlers(site site.API, cache *util.Cache) {
	...
	routes := map[string]route{
		...
		"buffermin":     {[]string{"POST", "OPTIONS"}, "/buffer/min/{value:[0-9.]+}", floatHandler(site.SetBufferMin, site.GetBufferMin)},
		"buffermax":     {[]string{"POST", "OPTIONS"}, "/buffer/max/{value:[0-9.]+}", floatHandler(site.SetBufferMax, site.GetBufferMax)},
