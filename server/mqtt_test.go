...
func (suite *mqttSuite) TestMeasurement() {
	topics := lo.Map([]string{
		"name", "title", "icon", "power", "energy", "returnEnergy", "powers", "currents", "excessDCPower", "capacity", "soc", "controllable", "suggestion", "maxChargePower", "maxDischargePower",
...
func (suite *mqttSuite) TestBatteryState() {
	topics := lo.Map([]string{
		"power", "energy", "capacity", "maxChargePower", "maxDischargePower", "soc",
		"devices", "devices/1/name", "devices/1/title", "devices/1/icon", "devices/1/power", "devices/1/energy", "devices/1/returnEnergy", "devices/1/powers", "devices/1/currents", "devices/1/excessDCPower", "devices/1/capacity", "devices/1/soc", "devices/1/controllable", "devices/1/suggestion", "devices/1/maxChargePower", "devices/1/maxDischargePower",
		"forecast",
	}, func(s string, _ int) string {
		return "test/" + s
	})
