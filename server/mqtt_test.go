...
func (suite *mqttSuite) TestMeasurement() {
	topics := lo.Map([]string{
		"name", "title", "icon", "usage", "power", "energy", "returnEnergy", "powers", "currents", "excessDCPower", "capacity", "soc", "controllable",
...
func (suite *mqttSuite) TestBatteryState() {
	topics := lo.Map([]string{
		...
		"devices", "devices/1/name", "devices/1/title", "devices/1/icon", "devices/1/usage", "devices/1/power", "devices/1/energy", "devices/1/returnEnergy", "devices/1/powers", "devices/1/currents", "devices/1/excessDCPower", "devices/1/capacity", "devices/1/soc", "devices/1/controllable",
		"forecast",
	}, func(s string, _ int) string {
		return "test/" + s
	})
