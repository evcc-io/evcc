...
func (m *MockAPI) Persist() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Persist")
}

// Persist indicates an expected call of Persist.
func (mr *MockAPIMockRecorder) Persist() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Persist", reflect.TypeOf((*MockAPI)(nil).Persist))
}
