...
replace github.com/enbility/ship-go => ../../enbility/ship-go
replace github.com/enbility/spine-go => ../../enbility/spine-go
replace github.com/enbility/eebus-go => ../../enbility/eebus-go
